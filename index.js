...
search.addEventListener("click", () => {
  const APIKey = "2e1a2bdfd526e01e0bdc9eb7598792b8";
    ...
    .then((json) => {
      ...
      if (cityHide.textContent == city) {
        ...
        switch (json.weather[0].main) {
          ...
          default:
            image.src = "images/sunny_cloud.png";
            break;
        }
        ...
        const CloneInfoWeather = document.querySelector(
          ".info-weather.active-clone"
        );

        const CloneInfoHumidity = document.querySelector(
